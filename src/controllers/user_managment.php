    ...
    <script>
        function filterTableAdmin() {
            ...
            if (selectedUser !== "") {
                ...
                document.getElementById("userDataTitle").style.display = "none"; // SkrĂ˝t novĂ˝ nadpis
                document.getElementById("userDataTitle2").style.display = "none"; // SkrĂ˝t novĂ˝ nadpis
